...
| **Erlang (Cowboy)** | ✅ | ✅ | ✅ | ✅ | [![Status](https://github.com/scherenhaenden/MagnetarYggdrasil/actions/workflows/Erlang.yml/badge.svg)](https://github.com/scherenhaenden/MagnetarYggdrasil/actions/workflows/Erlang.yml) | ✅ | Business Equal Ready |
| **F# (.NET AOT)** | ✅ | ❌ | ❌ | ❌ | ❓ | ❌ | Pending |
| **Fortran** | ❌ | ❌ | ❌ | ❌ | ❓ | ❌ | Pending |
